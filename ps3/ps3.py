...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.tile_cleanliness = {}
        for i in range(int(width)):
            for j in range(int(height)):
                self.tile_cleanliness[(i,j)] = self.dirt_amount
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        self.tile_cleanliness[(x,y)] = 0 if self.tile_cleanliness[(x,y)] - capacity < 0 \
            else self.tile_cleanliness[(x,y)] - capacity
    ...
    def is_tile_cleaned(self, m, n):
        ...
        return self.tile_cleanliness[(m,n)] == 0
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        # cleaned_tiles = 0
        # for tile in self.tile_cleanliness:
        #     if self.title_cleanliness[tile] == 0:
        #         cleaned_tiles += 1
        ...
        # init_list = []
        # for x in self.tile_cleanliness:
        #     if self.tile_cleanliness[x] == 0:
        #         init_list.append(x)
        # return len(init_list)
    
        return len([tile for tile in self.tile_cleanliness.keys() if self.tile_cleanliness[tile] == 0])
    ...
    def get_dirt_amount(self, m, n):
        ...
        Returns: an integer
        """
        return self.tile_cleanliness[(m,n)]
...
class EmptyRoom(RectangularRoom):
    ...
    def __init__(self, width, height, dirt_amount):
        """
        Initializes EmptyRoom, a subclass of RectangularRoom.
        """
...
class StandardRobot(Robot):
    ...
    def __init__(self, room, speed, capacity):
        """
        Initializes a StandardRobot, a subclass of Robot.
        """
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        robot_count = []
        robot_count = [robot_type(room, speed, capacity) for robot in range(num_robots)] 
        while room.get_num_cleaned_tiles() <= height * width:
            timestep += 1
            for robot in robot_count:
                robot.update_position_and_clean()
            if room.get_num_cleaned_tiles() / (width * height) >= min_coverage:
